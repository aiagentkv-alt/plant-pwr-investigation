#!/bin/bash
# Script para configurar búsquedas automatizadas diarias de Plant PWR

echo "🔧 CONFIGURANDO BÚSQUEDAS AUTOMATIZADAS DIARIAS"
echo "================================================"
...
# Crear script de búsqueda diaria
DAILY_SCRIPT="/root/.openclaw/workspace/plant-pwr-investigation/scripts/daily_whoogle_search.py"
...
echo "✅ Script diario creado: $DAILY_SCRIPT"

# Configurar cron job (ejecutar a las 9:00 AM todos los días)
CRON_JOB="0 9 * * * cd /root/.openclaw/workspace/plant-pwr-investigation/scripts && source venv/bin/activate && python3 daily_whoogle_search.py >> $LOG_DIR/cron.log 2>&1"

# Agregar al crontab si no existe
(crontab -l 2>/dev/null | grep -v "daily_whoogle_search.py"; echo "$CRON_JOB") | crontab -

echo "✅ Cron job configurado para ejecutarse diariamente a las 9:00 AM"
echo ""
echo "📋 RESUMEN DE CONFIGURACIÓN:"
echo "   • Script diario: $DAILY_SCRIPT"
echo "   • Logs: $LOG_DIR"
echo "   • Resultados: /root/.openclaw/workspace/plant-pwr-investigation/evidencia/"
echo "   • Cron job: 0 9 * * * (9:00 AM diario)"
echo ""
echo "🔍 Para probar manualmente:"
echo "   cd /root/.openclaw/workspace/plant-pwr-investigation/scripts"
echo "   source venv/bin/activate"
echo "   python3 daily_whoogle_search.py"
echo ""
echo "📊 Para ver logs:"
echo "   tail -f $LOG_DIR/whoogle_daily.log"